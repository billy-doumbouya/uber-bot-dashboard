...
const EDITABLE_KEYS = [
  { key: 'welcome_message', label: 'Message de bienvenue', type: 'textarea', rows: 4 },
  { key: 'closing_message', label: 'Message de clôture (après commande)', type: 'textarea', rows: 4 },
    ...
    <div className="space-y-5 max-w-2xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm">Personnaliser le comportement du bot</p>
        </div>
      ...
      <div className="card divide-y divide-gray-100">
        {EDITABLE_KEYS.map(({ key, label, type, rows }) => (
